...
This repository contains my personal copy of a group project completed for \*\*ELEC 376\*\* at \*\*Queen’s University\*\*.



The project focuses on building a \*\*semantic search system\*\* for a library-style dataset, allowing users to retrieve relevant results based on meaning rather than exact keyword matching.
...
&nbsp; - Demonstrating my contributions and understanding



I do \*\*not\*\* claim sole authorship of all code in this repository.
...
\- Applying semantic search concepts to real datasets

\- Working with NLP embeddings and similarity measures

\- Managing collaborative software development using Git

\- Debugging and improving moderately sized codebases

\- Communicating technical ideas within a team setting
